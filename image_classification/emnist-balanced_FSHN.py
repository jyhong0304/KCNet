...
# Parameters
#################
parser = argparse.ArgumentParser(description='Fully-trained Single-Hidden-layer Neural Network for EMNIST-Balanced')
...
dataset1 = datasets.EMNIST(root='~/data/emnist-balanced/', split='balanced', train=True, transform=transform, download=True)
dataset2 = datasets.EMNIST(root='~/data/emnist-balanced/', split='balanced', train=False, transform=transform, download=True)
train_loader = torch.utils.data.DataLoader(dataset1, **train_kwargs)
test_loader = torch.utils.data.DataLoader(dataset2, **test_kwargs)

model = FSHN(28*28, 254, 47).to(device)
