...
parser = argparse.ArgumentParser(description='ELM for Fashion-MNIST')
...
model = ELM(input_size=image_size, h_size=opt.hsize, num_classes=num_classes, device=device)
